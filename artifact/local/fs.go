...
func (a Artifact) Inspect(ctx context.Context) (types.ArtifactReference, error) {
	...
	err := a.walker.Walk(a.dir, func(filePath string, info os.FileInfo, opener analyzer.Opener) error {
		...
		if err = a.analyzer.AnalyzeFile(ctx, &wg, limit, map[types.CacheType]*analyzer.AnalysisResult{types.BuiltInCache: result}, a.dir, filePath, info, opener); err != nil {
	...
	cacheKey, err := cache.CalcKey(diffID, a.analyzer.AnalyzerVersions(types.BuiltInCache),
		a.hookManager.Versions(), a.artifactOption, a.configScannerOption)
	if err != nil {
