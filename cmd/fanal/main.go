...
func imageArtifact(ctx context.Context, imageName string, c cache.ArtifactCache,
	...
	art, err := aimage.NewArtifact(img, []cache.ArtifactCache{c}, artifactOpt, scannerOpt)
	if err != nil {
		return nil, func() {}, err
	}
...
func archiveImageArtifact(imagePath string, c cache.ArtifactCache) (artifact.Artifact, error) {
	...
	art, err := aimage.NewArtifact(img, []cache.ArtifactCache{c}, artifact.Option{}, config.ScannerOption{})
	if err != nil {
		return nil, err
	}
	return art, nil
